...
function vowelCount(str) {
    ...
    const vowels = [...lowCaseStr].filter (function (char) {
        return isVowel(char);
    })
    return vowels.reduce(function (newObj, vowel) {
        if (newObj[vowel] === undefined) {
            newObj[vowel] = 0;
        }
        newObj[vowel] += 1;
        return newObj;
...
function addKeyAndValue(arr, key, value) {
    return arr.reduce(function (newArr, personObj) { 
        personObj[key] = value;
...
function partition(arr, callback) {
    return arr.reduce(function (arrs, value) {
